properties {
   ...
   $ProjectPath = "$SrcPath\Grouchy.HttpApi.Client.Testing\Grouchy.HttpApi.Client.Testing.csproj"
   $TestProjectPath = "$SrcPath\Grouchy.HttpApi.Client.Testing.Tests\Grouchy.HttpApi.Client.Testing.Tests.csproj"
